...
('100', '5000000003', 'CUST000001', DATE '2026-03-02', DATE '2026-03-02', 'EUR', 420.00)
ON CONFLICT (mandt, vbeln) DO NOTHING;

INSERT INTO sap_vbap (mandt, vbeln, posnr, matnr, kwmeng, netwr, erdat, aedat) VALUES
('100', '5000000003', '000010', 'MAT-000000000001', 6.000, 420.00, DATE '2026-03-02', DATE '2026-03-02')
